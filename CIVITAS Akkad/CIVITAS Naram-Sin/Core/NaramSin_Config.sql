...
VALUES	('Players:StandardPlayers',		'CIVILIZATION_CVS_AKKAD',	'LEADER_CVS_NARAM_SIN',	'UNIT_CVS_AKKAD_UU',		'ICON_UNIT_CVS_AKKAD_UU',			'LOC_UNIT_CVS_AKKAD_UU_NAME',			'LOC_UNIT_CVS_AKKAD_UU_DESCRIPTION',			10			),
		('Players:StandardPlayers',		'CIVILIZATION_CVS_AKKAD',	'LEADER_CVS_NARAM_SIN',	'IMPROVEMENT_CVS_AKKAD_UI',	'ICON_IMPROVEMENT_CVS_AKKAD_UI',	'LOC_IMPROVEMENT_CVS_AKKAD_UI_NAME',	'LOC_IMPROVEMENT_CVS_AKKAD_UI_DESCRIPTION',		20			),
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_AKKAD',	'LEADER_CVS_NARAM_SIN',	'UNIT_CVS_AKKAD_UU',		'ICON_UNIT_CVS_AKKAD_UU',			'LOC_UNIT_CVS_AKKAD_UU_NAME',			'LOC_UNIT_CVS_AKKAD_UU_DESCRIPTION',			10			),
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_AKKAD',	'LEADER_CVS_NARAM_SIN',	'IMPROVEMENT_CVS_AKKAD_UI',	'ICON_IMPROVEMENT_CVS_AKKAD_UI',	'LOC_IMPROVEMENT_CVS_AKKAD_UI_NAME',	'LOC_IMPROVEMENT_CVS_AKKAD_UI_XP1_DESCRIPTION',	20			),
		('Players:Expansion2_Players',	'CIVILIZATION_CVS_AKKAD',	'LEADER_CVS_NARAM_SIN',	'UNIT_CVS_AKKAD_UU',		'ICON_UNIT_CVS_AKKAD_UU',			'LOC_UNIT_CVS_AKKAD_UU_NAME',			'LOC_UNIT_CVS_AKKAD_UU_DESCRIPTION',			10			),
