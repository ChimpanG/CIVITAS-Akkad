...
print ("Akkad Functions initialized")
...
-----------------------------------------------
	...
	local tValidAkkadPlayers = C15_GetValidTraitPlayers(sAkkadTrait)
...
-----------------------------------------------
-- FUNCTION C15_Akkad_CompBowTrain
-- Authors: Chrisy15
-----------------------------------------------
...
-----------------------------------------------
-- FUNCTION C15_Akkad_ConquerCityDoTurn
-- Authors: Chrisy15
-----------------------------------------------
...
function C15_Akkad_ConquerCityDoTurn(playerID)
	if tValidAkkadPlayers[playerID] then
		...
		if tConqCities and #tConqCities > 0 then
			...
			-- Well he did but now I've changed my mind
